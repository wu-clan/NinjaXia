...
v1.add_router('', v1_sys_user, tags=['v1_系统用户'])
v1.add_router('', v1_api_test_project, tags=['v1_api_项目管理'])
v1.add_router('', v1_api_test_module, tags=['v1_api_模块管理'])
v1.add_router('', v1_api_test_env, tags=['v1_api_环境管理'])
v1.add_router('', v1_api_test_business, tags=['v1_api_业务管理'])
v1.add_router('', v1_api_test_case, tags=['v1_api_用例管理'])
v1.add_router('', v1_api_test_task, tags=['v1_api_任务管理'])
v1.add_router('', v1_api_test_report, tags=['v1_api_报告管理'])
