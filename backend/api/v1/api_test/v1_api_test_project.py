...
@v1_api_test_project.put('/update/{pk}', summary='更新项目', auth=GetCurrentIsSuperuser())
...
@v1_api_test_project.delete('/delete/{pk}', summary='删除项目', auth=GetCurrentIsSuperuser())
...
@v1_api_test_project.get('/project_modules/{pk}', summary='获取单个项目所有模块', auth=GetCurrentUser())
