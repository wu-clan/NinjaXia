...
class ApiTestTask(Base):
    ...
    start_datetime = models.DateTimeField(max_length=64, verbose_name='起始时间')
    end_datetime = models.DateTimeField(max_length=64, verbose_name='截至时间')
    ...
    state = models.IntegerField(default=0, verbose_name='任务运行状态, 0: 等待执行, 1: 执行中, 2: 暂停')
