...
from backend.xia.common.security.jwt_security import create_access_token, GetCurrentUser, GetCurrentIsSuperuser
...
def update_user(request, obj: UpdateUser):
    ...
    try:
        ...
        return Response403(msg='电子邮件格式错误，请重新输入')
    _user = UserDao.put_user(current_user.pk, obj)
